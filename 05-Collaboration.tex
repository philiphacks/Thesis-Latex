...
%Generally, teamwork is strongly associated with a high degree of effectiveness and efficiency \cite{JigsawCSCL}. However, with respect to CSCL, there are arguments that explain both negative as well as positive effects. We can say that \textit{'cooperative learning is supporting the success in learning in general'}. This statement seems plausible, but we might as well state that: \textit{'you can decide neither theoretically nor empirically which social form of learning and working is better'}. In what follows, we will take three positions into consideration that argue on both positive as well as arguments speaking for CSCL.

%\subsubsection{Cognitive Elaboration}

%\subsubsection{Multiple contexts and perspectives}

%\subsubsection{Construction of shared knowledge} 
